...
mIAdd = MapI (IL []) (AddI (I 10)) (IL [1,2,3,4])
mISub = MapI (IL []) (SubI (I 1)) (IL [1,2,3,4])
mDAdd = MapD (DL []) (AddD (D 10)) (DL [1,2,3,4])
mDSub = MapI (IL []) (SubI (I 1)) (IL [1,2,3,4])
